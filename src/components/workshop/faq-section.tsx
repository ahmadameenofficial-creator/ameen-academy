...
const FAQS = [
  {
    question: "أنا مبتدئ خالص — الكورس ده هينفعني؟",
    answer:
      "أيوه، الكورس مصمم إنك تبدأ من الصفر تماماً. حتى لو عمرك ما فتحت فوتوشوب. هنمشي معاك خطوة بخطوة لحد ما تبقى قادر تاخد شغل وتكسب منه.",
  },
  {
    question: "أنا في كلية فنون تطبيقية — هستفيد إيه زيادة؟",
    answer:
      "الكلية بتعلمك نظريات. الكورس ده بيعلمك السوق — إزاي تجيب شغل، تسعّر، تسوّق لنفسك، وتبني اسم. ده بالظبط اللي الكلية مش بتعلمهولك. أغلب خريجين فنون تطبيقية قالوا إن الكورس ده كان اللي فهّمهم المجال فعلاً.",
  },
  {
