            ...
            <div className="lg:col-span-3 space-y-6">
              ...
              <FadeIn direction="right" delay={0.25}>
                <p className="text-muted-foreground leading-relaxed">
                  بدأت من الصفر زيك بالظبط. عديت بكل المراحل — من إني مكنتش
                  عارف أكسب جنيه من مهارتي، لحد ما بنيت اسم في السوق وعلّمت
                  300+ شخص يعملوا نفس الكلام. الكورس ده مش نظري — ده 10 سنين
                  خبرة مكثّفة في 30 ساعة عملي.
                </p>
              </FadeIn>
