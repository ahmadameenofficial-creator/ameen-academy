...
const VALUE_ITEMS = [
  ...
  },
  {
    ...
    forBeginner:
      "أنت محتاج حد يبصلك ويقولك «ده غلط، اعمله كده». مش أمك، مش صحبك المصمم اللي مهارته زيك. الـ 30 دقيقة دي بـ 1500 ج في السوق. هنا بييجي دورك تلقائي.",
    value: 1500,
